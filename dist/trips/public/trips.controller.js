...
let TripsController = class TripsController {
    ...
    async findAll(query, page, limit, is_highlight) {
...
__decorate([
    ...
    __param(3, (0, common_1.Query)('is_highlight', new common_1.ParseBoolPipe({ optional: true }))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [language_query_dto_1.LanguageQueryDto, Number, Number, Boolean]),
